#!/bin/bash
#SBATCH --job-name=SIDR_T5_old_pantheon_2
#SBATCH --partition=q128,q64
#SBATCH --mem-per-cpu=3g
#SBATCH --ntasks=6
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --time=100:00:00
#SBATCH --output=SIDR_interacting_and_std_mcmc_T_5_2mio_old_pantheon_2.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  -o chains/SIDR_interacting_and_std_T_5_2mio_old_pantheon_2 \
  --silent \
  -T 5.0
