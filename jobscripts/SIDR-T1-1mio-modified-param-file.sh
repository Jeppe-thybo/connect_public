...
#SBATCH --output=SIDR-T1-2mio-modified-param-file.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  --covmat /home/jthybo/connect_public/resources/montepython_public/chains/SIDR_interacting_and_std_T_3_1mio/SIDR_interacting_and_std_T_3_1mio.covmat \
  -o chains/SIDR-T1-2mio-modified-param-file \
  --silent \
  -T 1.0 \
  -j global \
  --superupdate 50
