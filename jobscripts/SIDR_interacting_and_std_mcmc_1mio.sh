#!/bin/bash
#SBATCH --job-name=SIDR_mcmc_1mio
...
#SBATCH --output=SIDR_interacting_and_std_mcmc_1mio.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  -p /home/jthybo/connect_public/mcmc_plugin/mp_param_templates/SIDR_interacting_and_std_1mio.param \
  ...
  -o chains/SIDR_interacting_and_std_1mio \
  --silent \
