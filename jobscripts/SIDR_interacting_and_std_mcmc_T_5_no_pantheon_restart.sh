#!/bin/bash
#SBATCH --job-name=SIDR_no_pantheon_restart
...
#SBATCH --output=SIDR_interacting_and_std_mcmc_T_5_no_pantheon_restart.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  --silent \
  -T 5.0 \
  --restart /home/jthybo/connect_public/resources/montepython_public/chains/SIDR_interacting_and_std_T_5_no_pantheon/2026-04-07_2000000__1.txt \
  -N 800000
