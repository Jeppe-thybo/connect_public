...
#SBATCH --output=SIDR_interacting_and_std_mcmc_T_5_4mio.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  -p /home/jthybo/connect_public/mcmc_plugin/mp_param_templates/SIDR_interacting_and_std_4mio.param \
  ...
  -o chains/SIDR_interacting_and_std_T_5_4mio \
  --silent \
  -T 5.0
