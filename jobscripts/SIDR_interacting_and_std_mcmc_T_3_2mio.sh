#!/bin/bash
#SBATCH --job-name=SIDR_T3_old_angular_and_pantheon
...
#SBATCH --output=SIDR_interacting_and_std_mcmc_T_3_2mio_old_angular_and_pantheon.out
...
srun --mpi=none --ntasks=6 --cpus-per-task=1 \
  ...
  -o chains/SIDR_interacting_and_std_T_3_2mio_old_angular_and_pantheon \
  --silent \
  -T 3.0
